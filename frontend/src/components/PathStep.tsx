      ...
      <div className="flex items-center gap-4">
        {movie.imdb_id ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex flex-col items-center text-current no-underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-purple-500 hover:text-purple-700"
          >
            {poster}
            <span className="mt-2 text-sm font-medium text-gray-900 max-w-[120px] text-center">
              {movie.title}
            ...
            {releaseYear}
            <span className="mt-1 text-xs text-purple-600 underline">
              View on IMDb
            </span>
          </a>
        ) : (

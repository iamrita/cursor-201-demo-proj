      ...
      <div className="flex items-center gap-4">
        {imdbUrl ? (
          <a
            ...
            className="flex flex-col items-center text-center rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-purple-500 transition hover:text-purple-700"
          >
            {movieDetails}
            <span className="mt-1 text-xs text-purple-600">View on IMDb ↗</span>
          </a>
        ) : (
